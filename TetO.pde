class TetO extends Tetronimoes{
  
 TetO(float x, float y){
   super(x, y);
 }
  ...
  super.makeBody(center);
   ...
   CircleShape circle1 = new CircleShape();
    ...
    Vec2 offset2 = new Vec2(d*0.5,d*0.866);
    ...
    Vec2 offset3 = new Vec2(d*1.5,d*0.866);
    offset3 = box2d.vectorPixelsToWorld(offset3);
    circle4.m_p.set(offset3.x,offset3.y);


    // create fixture definitions and add the bodies
